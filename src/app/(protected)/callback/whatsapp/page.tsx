...
//   // Set up the redirect URI on component mount
//   useEffect(() => {
//     // Store the exact redirect URI that was used
//     setRedirectUri(`${window.location.origin}/callback/whatsapp`)
//   }, [])
...
//         body: JSON.stringify({
//           code,
//           redirectUri, // Pass the exact redirect URI that was used
//         }),
//       })
...
//   const handleConnectMeta = () => {
//     // Redirect to Meta OAuth flow
//     const exactRedirectUri = `${window.location.origin}/callback/whatsapp`
//     setRedirectUri(exactRedirectUri)

//     const metaOAuthUrl = `https://www.facebook.com/v22.0/dialog/oauth?client_id=${process.env.NEXT_PUBLIC_META_APP_ID}&redirect_uri=${exactRedirectUri}&scope=whatsapp_business_management,whatsapp_business_messaging`
