...
// const processChartData = (engagementData: any[], commentData: any[]): ChartDataPoint[] => {
...
//     }
//     monthlyData[month].dms += item._count.id
//   })
...
//       monthlyData[month] = { dms: 0, comments: 0 }
//     }
//     monthlyData[month].comments += item._sum.commentCount || 0
//   })
...
//     queryKey: ["dashboard-data"],
//     queryFn: async () => {
//       // Assuming you have a way to get the userId. You might need to adjust this.
...
//     if (!data) return []
//     return processChartData(data.engagementData, data.commentData)
//   }, [data])
...
//   commentData.forEach((item) => {
//     const date = new Date(item.Automation.createdAt)
//     const month = date.toLocaleString("default", { month: "short" })
//     if (!monthlyData[month]) {
//       monthlyData[month] = { dms: 0, comments: 0 }
//     }
//     monthlyData[month].comments += item.commentCount
//   })
...
// const EnhancedChart: React.FC<EnhancedChartProps> = ({ userId }) => {
//   const [timeRange, setTimeRange] = useState<string>("6m")
//   const [viewMode, setViewMode] = useState<"both" | "dms" | "comments">("both")
