...
//   const processEngagementData = (dashboardData: DashboardData): EngagementData[] => {
//     const engagementMap = new Map<string, EngagementData>()

//     // Process automations data
//     dashboardData.automations.forEach((automation) => {
//       const date = new Date(automation.createdAt).toISOString().split("T")[0]
//       const existingData = engagementMap.get(date) || { date, dms: 0, comments: 0, likes: 0 }
//       if (automation.listener) {
//         existingData.dms += automation.listener.dmCount
//         existingData.comments += automation.listener.commentCount
//       }
...
//     // Process commentData
//     dashboardData.commentData.forEach((comment) => {
//       const date = comment.Automation.createdAt.toISOString().split("T")[0]
//       const existingData = engagementMap.get(date) || { date, dms: 0, comments: 0, likes: 0 }
//       existingData.comments += comment.commentCount
//       engagementMap.set(date, existingData)
//     })
...
//   const processEngagementData = (dashboardData: DashboardData["data"]): EngagementData[] => {
//     const engagementMap = new Map<string, EngagementData>()
