      ...
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center z-10">
        <div className="bg-[#1D1D1D] px-1 rounded-full border-[1px] border-[#545454]">
          {automation.listener?.listener === 'SMARTAI' ? (
            ...
            <span className="inline-block px-4 py-1 text-xs font-semibold uppercase text-white bg-blue-500 rounded-full shadow-md -my-[3px]">
              Standard
            </span>
          )}
        </div>
...
// export const FancyAutomationBox: React.FC<FancyAutomationBoxProps> = ({ automation, onDelete, pathname }) => {
//   return (
//     <div className="relative bg-[#1D1D1D] rounded-xl border-[1px] border-[#545454] overflow-hidden before:content-[''] before:absolute before:top-0 before:left-1/2 before:transform before:-translate-x-1/2 before:w-24 before:h-[1px] before:bg-[#1D1D1D] before:z-[1]">
//       <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center justify-center z-10">
//         <div className="bg-[#1D1D1D] px-1 rounded-full border-[1px] border-[#545454]">
//           {automation.listener?.listener === 'SMARTAI' ? (
//             <GradientButton
//               type="BUTTON"
//               className="text-xs bg-background-80 text-white hover:bg-background-80 px-4 py-1 -my-[1px]"
//             >
//               Smart AI
//             </GradientButton>
//           ) : (
//             <span className="px-4 py-1 text-xs font-semibold uppercase text-white bg-blue-500 rounded-full shadow-md -my-[1px] block">
//               Standard
//             </span>
//           )}
//         </div>
...
//         <div className="bg-[#1D1D1D] px-1 py-0.5 rounded-full border-[1px] border-[#545454]">
//           {automation.listener?.listener === 'SMARTAI' ? (
//             <GradientButton
//               type="BUTTON"
//               className="text-xs bg-background-80 text-white hover:bg-background-80 px-4 py-1 -my-0.5"
//             >
//               Smart AI
//             </GradientButton>
//           ) : (
//             <span className="px-4 py-1 text-xs font-semibold uppercase text-white bg-blue-500 rounded-full shadow-md -my-0.5">
//               Standard
//             </span>
//           )}
//         </div>
