              ...
              <>
                ...
                <div className="flex flex-1">
                  <div className="flex flex-wrap gap-4 p-4">
                    {!token ? (
                      <div className="w-3/4 md:w-3/4 lg:w-2/3 p-4 bg-background rounded-lg shadow-md">
                        <p className="text-muted-foreground text-center py-4">no chats</p>
                        <div className="text-center">
                          <p className="text-muted-foreground mb-4 text-sm sm:text-base">
                            Connect your Instagram account to start receiving real messages.
                          </p>
                      ...
                      <div className="col-span-full p-4 bg-background rounded-lg shadow-md text-center py-8">
                        <p className="text-muted-foreground">no chats</p>
                      </div>
                    ) : (
                      <>
                        {conversations.map((conversation) => (
