    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link href="/onboarding/user">Log in</Link>
          </Button>
          <Button className="bg-blue-600 hover:bg-blue-700 text-white"><Link href="/onboarding/user">Get Started</Link></Button>
        </div>
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              ...
              <div className="flex flex-col space-y-2 pt-2 border-t border-blue-900/30">
                ...
                <Button className="justify-center bg-blue-600 hover:bg-blue-700 text-white"><Link href="/onboarding/user">Get Started</Link></Button>
              </div>
            </div>
          </motion.div>
        )}
