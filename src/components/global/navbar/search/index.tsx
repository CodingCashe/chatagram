...
//         )}
//       </div>
//       <Dialog open={isOpen && searchTerm.length > 0} onOpenChange={setIsOpen}>
//         <DialogContent className="sm:max-w-[800px] bg-[#1D1D1D] border-[#545454]">
//           <AnimatePresence>
//             <motion.div
//               initial={{ opacity: 0, y: -10 }}
//               animate={{ opacity: 1, y: 0 }}
...
//       setFilteredAutomations(filtered)
//       setSelectedIndex(-1)
//       setIsOpen(searchTerm.length > 3) // Only open dialog if there's a search term
//     }, 300),
