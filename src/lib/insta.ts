  ...
  try {
    ...
    const createdContent = await client.scheduledContent.create({
      data: {
        ...
        caption: newContent.caption,
        mediaType: newContent.media_type,
        mediaUrl: "https://example.com/images/beach-sunset.jpg",
        thumbnailUrl:"https://example.com/images/beach-sunset.jpg",
        permalink: "https://example.com/images/beach-sunset.jpg",
        scheduledDate: new Date(newContent.timestamp),
        userId: user.id,
        status: "scheduled",
        // instagramPostId: newContent.id,
